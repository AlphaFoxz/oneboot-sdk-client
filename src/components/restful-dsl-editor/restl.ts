  ...
  languages.setMonarchTokensProvider('restl', {
    ...
    tokenizer: {
      ...
      interface_body: [
        ...
        [/\benum\b/, { token: 'support.type.builtin.ts', next: '@type_t' }],
        [/\b(i16|i32|i64|short|int|long|boolean|string|binary|byte)\b/, { token: 'support.type.builtin.ts' }],
      ...
      class_body: [
        ...
        [/[!|?]/, { token: 'keyword.operator.optional' }],
        [/\/\/.*$/, 'comment'],
        [/\/\*/, { token: 'keyword.operator.assignment.compound.js', next: '@comment_doc' }],
      ],
      enum: [
        [/[}]/, { token: 'operator', next: '@pop' }],
      ...
      type: [
        ...
        [/\benum\b/, { token: 'support.type.builtin.ts', next: '@type_t' }],
        [
          /\b(i16|i32|i64|short|int|long|boolean|string|binary|byte)\b/,

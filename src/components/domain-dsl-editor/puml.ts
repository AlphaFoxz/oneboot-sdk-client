...
export function registerPuml(monaco: { editor: any; languages: any }) {
  ...
  */
  languages.register({
    ...
    aliases: ['puml'],
    extensions: ['.puml'],
    mimetypes: ['text/x-puml', 'text/x-puml-source'],
  })
  languages.setLanguageConfiguration('puml', {
    comments: {
      lineComment: "'",
  ...
  languages.setMonarchTokensProvider('puml', {
    keyword: ['DomainEvent', 'Event', 'System', 'Aggregate', 'Command', 'Rule', 'Field'],
    tokenizer: {
      root: [

...
<template>
  <svg
    ...
    height="1em"
    aria-hidden="true"
    class="globalization hover:text-primary hover:!bg-[transparent] w-[20px] h-[20px] ml-1.5 cursor-pointer outline-none duration-300 el-tooltip__trigger el-tooltip__trigger"
    viewBox="0 0 512 512"
    id="el-id-1710-69"
    role="button"
    tabindex="0"
    aria-controls="el-id-1710-70"
    aria-expanded="true"
    aria-haspopup="menu"
  >
    <path
      :fill="useUserPreferenceStore().state.svgColor.value"

...
pub mod restful_dsl_api {
    ...
    use super::super::super::dtos::sdk_version_dto;
    use crate::core::error::Error;

    ///创建Ts client的Api代码
    pub async fn generate_ts_client_api(
        _template_dto: sdk_request_dto::SdkCodeTemplateRequestDto,
        _gen_dir: String,
    ) -> Result<sdk_response_dto::SdkMapResponseDto, Error> {
    ...
    pub async fn generate_java_server_api(
        _template_dto: sdk_request_dto::SdkCodeTemplateRequestDto,
    ) -> Result<sdk_response_dto::SdkListResponseDto, Error> {
    ...
    ) -> Result<sdk_version_dto::SdkVersionCheckResponse, Error> {
        let __res = reqwest::Client::new()
